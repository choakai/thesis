...
connStr_ado = 'Provider=SQLNCLI11.1;Data Source=(local);Initial Catalog=THESIS;User ID=sa;Password=P@ssw0rd;' #%('','url_src' ,'sa', 'P@ssw0rd')
...
f = codecs.open(FilePath +"PPT_PoliticMan_" + now.strftime("%Y%m%d%H%M") + "_url.txt", "w+", "utf-8")
